...
int main(void)
{
  ...
  HAL_GPIO_TogglePin(GPIOB,GPIO_PIN_9); // TOGGLE MR OFF
...
void StartTask2(void *argument)
{
  ...
  {
	  if (flag) {
		  HAL_GPIO_TogglePin(GPIOB,GPIO_PIN_5);//Yellow LED ON
		  osDelay(3000);
		  HAL_GPIO_TogglePin(GPIOB,GPIO_PIN_5);//Yellow LED OFF
		  osDelay(12000);
		  HAL_GPIO_TogglePin(GPIOB,GPIO_PIN_5);//Yellow LED ON
		  osDelay(2000);
		  HAL_GPIO_TogglePin(GPIOB,GPIO_PIN_5);//Yellow LED OFF
...
void StartTask3(void *argument)
{
  ...
  for(;;)
  {
	  ...
	  if (flag) {
		  osDelay(3000);
		  HAL_GPIO_TogglePin(GPIOB,GPIO_PIN_3);//RED LED ON
		  osDelay(14000);
		  HAL_GPIO_TogglePin(GPIOB,GPIO_PIN_3);//RED LED OFF
	  }
...
void StartTask4(void *argument)
{
  ...
  for(;;)
  {
	  if(flag)
	  {
//		 HAL_GPIO_TogglePin(GPIOB,GPIO_PIN_8); // TOGGLE MR ON
		 osDelay(4000);
	     HAL_GPIO_TogglePin(GPIOB,GPIO_PIN_8); //TOGGLE MR OFF
		 osDelay(10000);
	     HAL_GPIO_TogglePin(GPIOB,GPIO_PIN_8); //TOGGLE MR ON
	 	}
  }
...
//		 HAL_GPIO_TogglePin(GPIOB,GPIO_PIN_9); // TOGGLE MR OFF
		 osDelay(4000);
		 HAL_GPIO_TogglePin(GPIOB,GPIO_PIN_9); //TOGGLE MR ON
		 osDelay(10000);
		 HAL_GPIO_TogglePin(GPIOB,GPIO_PIN_9); //TOGGLE MR OFF
